        ...
        return (
            <View style={styles.container}>
                ...
                <ScrollView style={styles.footer}>
                    ...
                    <Text numberOfLines={2} style={styles.textDetail}>The template details auto text code displays the complete template details, including attribute
details and metric details.</Text>
                    <LinearGradient
                        start={{ x: 0, y: 0 }}
                        end={{ x: 1, y: 0 }}
